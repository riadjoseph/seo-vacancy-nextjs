...
const Footer = () => {
  const totalJobs = 313; // Example total jobs count, replace with actual data
  const dateUpdated = "21 June 2025"; // Example date, replace with actual data
  const topCities = [
    { name: "Amsterdam", count: 14 },
    { name: "Leeds", count: 13 },
    { name: "Madrid", count: 12 },
  ];
