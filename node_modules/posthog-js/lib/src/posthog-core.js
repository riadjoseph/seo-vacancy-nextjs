...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        if (event_name === SurveyEventName.DISMISSED || event_name === SurveyEventName.SENT) {
            var surveyId = properties === null || properties === void 0 ? void 0 : properties[SurveyEventProperties.SURVEY_ID];
            var surveyIteration = properties === null || properties === void 0 ? void 0 : properties[SurveyEventProperties.SURVEY_ITERATION];
            localStorage.setItem(getSurveySeenKey({ id: surveyId, current_iteration: surveyIteration }), 'true');
            data.$set = __assign(__assign({}, data.$set), (_a = {}, _a[getSurveyInteractionProperty({ id: surveyId, current_iteration: surveyIteration }, event_name === SurveyEventName.SENT ? 'responded' : 'dismissed')] = true, _a));
        }
